...
// .vgd-section-block:nth-child(3) .vgd-section-name,
// .vgd-section-block:nth-child(4) .vgd-section-name {
//   left: 60%;
// }
...
export default function LedGridVerticalOneRowUpDisplay() {
  const { id } = useParams();
  ...
  const connectWebSocket = (targetAreaId) => {
    ...
    ws.onopen = () => {
      ...
      heartbeatRef.current = setInterval(() => {
        ...
        if (Date.now() - lastMsgRef.current > 40000) {
          ws.close();
        }
      }, 15000);
    };
